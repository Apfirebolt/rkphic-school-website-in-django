...
from rkphic_school.views import NotificationListView, StudentListView, GalleryListView
...
urlpatterns = [
    ...
    path('gallery', GalleryListView.as_view(template_name='gallery.html'), name='gallery'),
